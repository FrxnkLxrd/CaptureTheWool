...
public enum XEnchantment {
    ...
    public static boolean isArthropodsEffectiveAgainst(EntityType type) {
        return Arrays.asList(EntityType.SPIDER, EntityType.CAVE_SPIDER, EntityType.SILVERFISH, EntityType.ENDERMITE).contains(type);
    }
    ...
    public Enchantment parseEnchantment() {
        return ISFLAT ? Enchantment.getByName(this.name()) : Enchantment.getByName(this.name());
    }
